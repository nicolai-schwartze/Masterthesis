# -*- coding: utf-8 -*-
"""
Created on Thu Jul 16 13:14:42 2020
...
if __name__ == "__main__":
    ...
    save_path = "D:/Nicolai/MA_Data/time_experiment_3/"
...
#        print(save_path + "cipde0a_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
    ...
    for i in range(replications):
        cipde0B[i].solve()
        pp.saveExpObject(cipde0B[i], save_path + "cipde0b_mpjgsk_rep_" + str(i) + ".json")
        print(save_path + "cipde0b_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
...
#        print(save_path + "cipde1_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
#        
#    ##########################
#    #   testbed problem 2    #
#    ##########################
...
#    for i in range(replications):
#        cipde2[i].solve()
#        pp.saveExpObject(cipde2[i], save_path + "cipde2_mpjgsk_rep_" + str(i) + ".json")
#        print(save_path + "cipde2_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
#    
#    ##########################
#    #   testbed problem 3    #
#    ##########################
...
#    for i in range(replications):
#        cipde3[i].solve()
#        pp.saveExpObject(cipde3[i], save_path + "cipde3_mpjgsk_rep_" + str(i) + ".json")
#        print(save_path + "cipde3_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
#        
#    ##########################
#    #   testbed problem 4    #
#    ##########################
...
#    for i in range(replications):
#        cipde4[i].solve()
#        pp.saveExpObject(cipde4[i], save_path + "cipde4_mpjgsk_rep_" + str(i) + ".json")
#        print(save_path + "cipde4_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
#        
#    ##########################
#    #   testbed problem 5    #
#    ##########################
...
#    for i in range(replications):
#        cipde5[i].solve()
#        pp.saveExpObject(cipde5[i], save_path + "cipde5_mpjgsk_rep_" + str(i) + ".json")
#        print(save_path + "cipde5_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
#        
#    ##########################
#    #   testbed problem 6    #
#    ##########################
...
#    for i in range(replications):
#        cipde6[i].solve()
#        pp.saveExpObject(cipde6[i], save_path + "cipde6_mpjgsk_rep_" + str(i) + ".json")
#        print(save_path + "cipde6_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
#        
#    ##########################
#    #   testbed problem 7    #
#    ##########################
...
#    for i in range(replications):
#        cipde7[i].solve()
#        pp.saveExpObject(cipde7[i], save_path + "cipde7_mpjgsk_rep_" + str(i) + ".json")
#        print(save_path + "cipde7_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
#        
#    ##########################
#    #   testbed problem 8    #
#    ##########################
...
#    for i in range(replications):
#        cipde8[i].solve()
#        pp.saveExpObject(cipde8[i], save_path + "cipde8_mpjgsk_rep_" + str(i) + ".json")
#        print(save_path + "cipde8_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
#        
#    ##########################
#    #   testbed problem 9    #
#    ##########################
...
#    for i in range(replications):
#        cipde9[i].solve()
#        pp.saveExpObject(cipde9[i], save_path + "cipde9_mpjgsk_rep_" + str(i) + ".json")
#        print(save_path + "cipde9_mpjgsk_rep_" + str(i) + ".json" + " -> saved")
#        
#        
