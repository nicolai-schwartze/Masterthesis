...
\begin{table}[h]
	...
	\unterschrift{Literature research on the general topic of stochastic slovers and their application. The papers are sorted by relevance to the present work. }{}{}
