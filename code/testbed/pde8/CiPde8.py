# -*- coding: utf-8 -*-
"""
Created on Sat May 16 13:45:02 2020
...
if __name__ == "__main__":
    ...
    cipde8 = CiPde8(mpJade, gkernel, nb, nc)
    
    print(cipde8.pde_string)
    
    try:
        cipde8.exact(np.array([0.5,0.5]))
    except:
        print("Î error message above")
    
    try:
        cipde8.approx(np.array([0.5,0.5]))
    except:
        print("Î error message above")
    ...
    print("exact(0.5, 0.5) = {}".format(cipde8.exact(np.array([0.5,0.5]))))
    print("approx(0.5, 0.5) = {}".format(cipde8.approx(np.array([0.5,0.5]))))
    print("L2 norm to the real solution {}".format(cipde8.normL2()))
    print("solving took {} sec".format(cipde8.exec_time))
    print("solving uses {} Mb".format(cipde8.mem_consumption/1000000))
