# -*- coding: utf-8 -*-
"""
Created on Thu May 14 18:01:46 2020
...
if __name__ == "__main__":
    ...
    cipde3 = CiPde3(mpJade, gkernel, nb, nc)
    
    print(cipde3.pde_string)
    
    try:
        cipde3.exact(np.array([0.0,0.0]))
    except:
        print("Î error message above")
    
    try:
        cipde3.approx(np.array([0.0,0.0]))
    except:
        print("Î error message above")
    ...
    print("exact(0.0, 0.0) = {}".format(cipde3.exact(np.array([0.0,0.0]))))
    print("approx(0.0, 0.0) = {}".format(cipde3.approx(np.array([0.0,0.0]))))
    print("L2 norm to the real solution {}".format(cipde3.normL2()))
    print("solving took {} sec".format(cipde3.exec_time))
    print("solving uses {} Mb".format(cipde3.mem_consumption/1000000))
