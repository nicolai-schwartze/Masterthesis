...
\setLanguage{\newLanguage}
\setTitle{Computational Intelligence Method for Solving Partial Differential Equations}
...
\begin{document}
	...
	\begin{envModeNot}[\presentations]
		...
		\subfile{./tex/UAT_Gauss_Sine_Kernel.tex}
		\subfile{./tex/Multimodality_and_Symmetry.tex}
