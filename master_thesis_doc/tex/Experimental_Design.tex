...
Although the post processing block is not actually a class, it is still represented in this diagram. This module provides funtions that take \inlinecode{FemPdeN} or \inlinecode{CiPdeN} objects and perform actions with them. \todo{update implemented function description and class diagram in appendix}
