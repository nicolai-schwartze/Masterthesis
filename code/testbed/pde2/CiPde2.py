...
if __name__ == "__main__":
    ...
    cipde2 = CiPde2(mpJade, gkernel, nb, nc)
    
    print(cipde2.pde_string)
    
    try:
        cipde2.exact(np.array([0.0,0.0]))
    except:
        print("Î error message above")
    
    try:
        cipde2.approx(np.array([0.0,0.0]))
    except:
        print("Î error message above")
